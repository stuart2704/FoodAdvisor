  ...
  return [
    {
      ...
      body: [
        "Hi {{restaurant_name}},",
        "",
        "I run The Food Advisor — a curated directory of great restaurants.",
        "",
        "We’d love to feature you. Can I send more details?",
        "",
        UNSUBSCRIBE_FOOTER,
      ].join("\r\n"),
    ...
    {
      subject: "Following up — The Food Advisor",
      body: [
        "Hi again {{restaurant_name}},",
        "",
        "Just checking in — we’d still love to include you.",
        "",
